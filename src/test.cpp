...
void cb_punt(RangeOperator_t r, const std::map<string,string> &m, void *ptr){
  stack<int> *stk = (stack<int>*)ptr;
  int indent = stk->top();
  stk->pop();
...
void cb_punt_int(RangeOperator_t r, const std::map<int,string> &m, void *ptr){
  stack<int> *stk = (stack<int>*)ptr;
  int indent = stk->top();
  stk->pop();
...
int main(){
  ...
  string dfl_val_1("DEFAULT1"); 
  string dfl_val_2("DEFAULT2"); 
  string a_k("chiave_a");
  string a_val("valore_a");
  string b_k("chiave_b");
  string b_val("valore_b");
  string c_k("chiave_c");
  string c_val("valore_c");
  ...
  string less_than_1024("lesser than 1024");
  string eq_to_80("equal to 80");
  string great_eq_32000("greater than or equal to 32000");
  string dfl_val_3("DEFAULT3");
